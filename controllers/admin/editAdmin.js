...
const editAdmin = async (req, res) => {
    try {
        ...
        return successResponse(res, 200, "Admin details updated successfully", { admin: updatedAdmin });
    } catch (error) {
        console.error("Error updating admin details:", error);
        return errorResponse(res, 500, "Failed to update admin details", { error: error.message });
    }
};
